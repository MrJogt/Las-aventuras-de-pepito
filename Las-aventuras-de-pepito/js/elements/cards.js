    ...
    cards.list[id] = {
      ...
      checkClick: function () {
        ...
        && mouse.y < (this.y + this.height)) {
         //&& (!this.selected || !cards.lastChoose)) {
           //console.log(!this.selected, !cards.lastChoose);
          this.selected = true;
          if(cards.lastChoose) {
      ...
      render: function() {
        ...
        if(this.selected) {
          text.draw(this.group, '#fff', null, null, null, null, this.x + (this.width/2), this.y + (this.height/2))
        }
      }
    };
  }
